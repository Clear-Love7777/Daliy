<template>
  <div>
    ...
    <el-dialog title="分配权限" @close="setRightDialogClosed" :visible.sync="setRightDialogVisible" width="50%">
      <!-- 树形控件 -->
    <el-tree :default-checked-keys="defKeys" ref="treeRef" :data="rightslist" :props="treeProps" show-checkbox node-key="id" default-expand-all></el-tree>
...
export default {
  ...
  async  showSetRightDialog(role) {
    ...
    //通过递归的形式 获取角色下所有三级权限的id并保存到deKeys数组中
